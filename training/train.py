...
from diffusers import UNet2DConditionModel, EMAModel, DDPMScheduler, AutoencoderKL
...
def main():
    ...
    if args.use_ema:
        ema_unet = _load_unet(component_name="unet", path=args.pretrained_model_name_or_path, torch_dtype=weight_dtype)
